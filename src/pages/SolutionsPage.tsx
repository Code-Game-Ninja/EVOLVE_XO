    ...
    <div ref={containerRef} className="relative bg-[#0A0A0A]">
      ...
      <div className="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-3">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-[#FFFFFF]/10 -z-10">
          <div 
            ref={progressRef}
            className="w-full bg-[#D9E6FF] origin-top"
      ...
      <section className="min-h-screen flex flex-col justify-center items-center px-6 lg:px-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto">
          ...
          <h1 className="text-display text-[#F5F5F2] mb-8">
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-[#B7B7B2] max-w-2xl mx-auto mb-12"
          >
          ...
          >
            <span className="text-xs text-[#6B6B68] uppercase tracking-wider">Scroll to begin the journey</span>
            <motion.div
              animate={{ y: [0, 10, 0] }}
              ...
              <div className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${isEven ? '' : 'lg:flex-row-reverse'}`}>
                ...
                <div className={`flex justify-center ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                  <div className="icon-wrapper relative">
                    ...
                    >
                      ...
                      {/* Click hint */}
                      <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 text-xs text-[#6B6B68] whitespace-nowrap hidden sm:block">
                        Click for details
                      </div>
                    </motion.div>
                  </div>
                ...
                <div className={`story-content ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                  <div className="flex items-center gap-4 mb-4">
                    <span className="text-sm font-mono text-[#6B6B68]">
                      {solution.id} / 04
                    </span>
                    <div className="flex gap-2 flex-wrap">
                      {solution.tags.map((tag) => (
                        <span 
                          key={tag} 
                          className="tag-pill text-xs px-3 py-1 rounded-full border border-[#FFFFFF]/10 text-[#B7B7B2]"
                        >
                          {tag}
                        </span>
                      ))}
                  ...
                  <h3 className="text-sm font-medium uppercase tracking-[0.2em] mb-2" style={{ color: solution.color }}>
                    {solution.subtitle}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 mb-6 sm:mb-8">
                    {solution.benefits.slice(0, 4).map((benefit, i) => (
                      <div 
                        key={i}
                        className="benefit-item flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg sm:rounded-xl bg-[#FFFFFF]/5 border border-[#FFFFFF]/5"
                      >
                        <div 
                          className="w-2 h-2 rounded-full flex-shrink-0"
                          style={{ background: solution.color }}
                        />
                        <span className="text-xs sm:text-sm text-[#B7B7B2]">{benefit}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <MagneticButton onClick={() => navigate('/contact')}>
                      <span className="text-[#6B6B68] hover:text-[#F5F5F2] transition-colors text-sm">
                        Get Started →
                      </span>
                    </MagneticButton>
                  </div>
          ...
          >
            ...
            <div className="relative min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-12">
              ...
              <motion.div
                ...
                className="relative w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-[#121212] border border-[#FFFFFF]/10 rounded-3xl shadow-2xl"
              >
                {/* Close Button */}
                <button
                  onClick={handleCloseSolution}
                ...
                <div className="p-8 sm:p-12 border-b border-[#FFFFFF]/10 sticky top-0 bg-[#121212] z-10">
                  <div className="flex items-start gap-6">
                    ...
                    >
                      <selectedSolution.icon size={40} style={{ color: selectedSolution.color }} />
                    </motion.div>
                ...
                <div className="p-8 sm:p-12 space-y-12">
                  ...
                  >
                    <h3 className="text-sm font-medium text-[#F5F5F2] uppercase tracking-[0.2em] mb-6 flex items-center gap-3">
                      <Target size={18} style={{ color: selectedSolution.color }} />
                      Key Benefits
                    </h3>
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      {selectedSolution.benefits.map((benefit, i) => (
                        ...
                        >
                          ...
                          />
                          <span className="text-[#B7B7B2]">{benefit}</span>
                        </motion.div>
                      ))}
                    </div>
                  </motion.div>
                  ...
                  >
                    <h3 className="text-sm font-medium text-[#F5F5F2] uppercase tracking-[0.2em] mb-6 flex items-center gap-3">
                      <Clock size={18} style={{ color: selectedSolution.color }} />
                      Implementation Timeline
                    </h3>
                    
                    <div className="relative">
                      {/* Timeline Line */}
                      <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-[#FFFFFF]/10 hidden sm:block" />
                          ...
                          >
                            ...
                            <div className="hidden sm:flex flex-col items-center">
                              <div
                                ...
                                style={{ background: `${selectedSolution.color}20` }}
                              >
                                <span className="text-lg font-bold" style={{ color: selectedSolution.color }}>
                                  {i + 1}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="flex-1 pt-2">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-1">
                                <h4 className="text-[#F5F5F2] font-medium text-lg">{step.phase}</h4>
                                <span 
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                      <div className="flex items-center gap-3">
                        <Users size={20} style={{ color: selectedSolution.color }} />
                        <span className="text-[#B7B7B2]">Join 50+ companies who chose this solution</span>
                      </div>
      ...
      {/* Final CTA Section */}
      <section className="min-h-screen flex flex-col justify-center items-center px-6 lg:px-12 relative py-24">
        <div className="text-center max-w-3xl mx-auto">
          <motion.h2 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-heading-1 text-[#F5F5F2] mb-6"
          >
